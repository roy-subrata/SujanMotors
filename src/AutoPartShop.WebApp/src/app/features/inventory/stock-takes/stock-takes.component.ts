...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, TableModule, ToastModule, TooltipModule, DialogModule, SelectModule, TextareaModule, PageContainerComponent, PageHeaderComponent, FilterBarComponent, DataPaginationComponent, TranslatePipe],
...
export class StockTakesComponent implements OnInit {
    ...
    statusOptions: { label: string; value: StockTakeStatus | null }[] = [];
    ...
    refreshData(): void {
        this.loadStockTakes(this.currentPage, this.rows);
    }
    ...
    goToPage(page: number): void {
        this.loadStockTakes(page, this.rows);
    }
    onPageSizeChange(size: number): void {
        this.loadStockTakes(1, size);
    }
