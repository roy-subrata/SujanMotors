...
export class PartsFormDialogComponent implements OnInit {
    ...
    onCreateSubmit(): void {
        ...
        const request: CreatePartRequest = {
            ...
            productType: this.createForm.get('productType')?.value ?? 'PHYSICAL',
            isPerishable: this.createForm.get('isPerishable')?.value ?? false,
    ...
    onUpdateSubmit(): void {
        ...
        const request: UpdatePartRequest = {
            ...
            productType: this.updateForm.get('productType')?.value ?? 'PHYSICAL',
            isPerishable: this.updateForm.get('isPerishable')?.value ?? false,
