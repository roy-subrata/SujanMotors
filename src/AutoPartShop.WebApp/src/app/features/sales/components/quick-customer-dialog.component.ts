...
@Component({
  ...
  template: `
    <p-dialog
      ...
      [resizable]="false"
      [closable]="true"
      styleClass="quick-customer-dialog">
      ...
      <form [formGroup]="customerForm" (ngSubmit)="onSubmit()" class="customer-form">
        ...
        <div class="form-row two-col">
          <div class="form-field">
            ...
            />
            <small class="error-text" *ngIf="customerForm.get('firstName')?.invalid && customerForm.get('firstName')?.touched">
          ...
          <div class="form-field">
            ...
            />
            <small class="error-text" *ngIf="customerForm.get('lastName')?.invalid && customerForm.get('lastName')?.touched">
        ...
        <div class="form-row two-col">
          <div class="form-field">
            ...
            />
            <small class="error-text" *ngIf="customerForm.get('phone')?.invalid && customerForm.get('phone')?.touched">
          ...
          <div class="form-field">
            ...
            />
            <small class="error-text" *ngIf="customerForm.get('email')?.invalid && customerForm.get('email')?.touched">
