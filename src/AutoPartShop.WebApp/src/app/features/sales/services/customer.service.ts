...
export class CustomerService {
  ...
  private readonly apiUrl = 'http://localhost:5292/api/customer';
  ...
  getCustomers(
    ...
    pageSize: number = 10,
    searchTerm?: string
  ): Observable<PaginatedResponse<CustomerResponse>> {
    ...
    return this.http.get<PaginatedResponse<CustomerResponse>>(
      `${this.apiUrl}/list`,
      { params }
    );
  }
