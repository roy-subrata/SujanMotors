...
namespace AutoPartsShop.Infrastructure.Migrations
{
    ...
    [Migration("20251209173857_AddedStockLevelConfiguration")]
    partial class AddedStockLevelConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.TechnicianOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TechnicianOrders");
                });

            modelBuilder.Entity("AutoPartShop.Domain.Entities.TechnicianOrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("TechnicianOrderId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TechnicianOrderId");

                    b.ToTable("TechnicianOrderLine");
                });

            modelBuilder.Entity("AutoPartShop.Domain.Entities.TechnicianPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.CustomerPayment", b =>
                {
                    ...
                    b.HasOne("AutoPartShop.Domain.Entities.Invoice", null)
                        .WithMany("CustomerPayments")
                    ...
                    b.OwnsMany("AutoPartShop.Domain.Entities.InvoicePayment", "Payments", b1 =>
                        {
                            ...
                            b1.HasOne("AutoPartShop.Domain.Entities.Invoice", "Invoice")
                                .WithMany()
                                .HasForeignKey("InvoiceId1");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.TechnicianOrderLine", b =>
                {
                    ...
                    b.HasOne("AutoPartShop.Domain.Entities.TechnicianOrder", "TechnicianOrder")
                        .WithMany("LineItems")
                        .HasForeignKey("TechnicianOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Part");

                    b.Navigation("TechnicianOrder");
                });
