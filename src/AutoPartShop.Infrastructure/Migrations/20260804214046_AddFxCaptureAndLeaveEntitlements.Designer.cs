...
namespace AutoPartShop.Infrastructure.Migrations
{
    ...
    [Migration("20260804214046_AddFxCaptureAndLeaveEntitlements")]
    partial class AddFxCaptureAndLeaveEntitlements
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.BackupRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.CashDeposit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.Challan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.ChallanLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.Ecommerce.CartReservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.HR.AttendanceRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.HR.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal?>("CasualLeaveEntitlement")
                        .HasPrecision(10, 1)
                        .HasColumnType("decimal(10,1)");
                    ...
                    b.Property<decimal?>("SickLeaveEntitlement")
                        .HasPrecision(10, 1)
                        .HasColumnType("decimal(10,1)");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.HR.Holiday", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.HR.LeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.HR.PayrollRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.HR.Payslip", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.HR.SalaryAdvance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SalaryAdvances", "hr");
                });

            modelBuilder.Entity("AutoPartShop.Domain.Entities.HR.Shift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.InboxNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.ProductEmbedding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.ProductSpecification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.StockLevel", b =>
                {
                    ...
                    b.HasIndex("PartId", "VariantId", "WarehouseId")
                        .IsUnique()
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.StoredFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.ChallanLine", b =>
                {
                    b.HasOne("AutoPartShop.Domain.Entities.Challan", "Challan")
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.HR.AttendanceRecord", b =>
                {
                    b.HasOne("AutoPartShop.Domain.Entities.HR.Employee", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.HR.Employee", b =>
                {
                    b.HasOne("AutoPartShop.Domain.Entities.HR.Shift", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.HR.Payslip", b =>
                {
                    ...
                    b.HasOne("AutoPartShop.Domain.Entities.HR.PayrollRun", null)
                        .WithMany("Payslips")
            ...
            modelBuilder.Entity("AutoPartShop.Domain.Entities.ProductEmbedding", b =>
                {
                    b.HasOne("AutoPartShop.Domain.Entities.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
