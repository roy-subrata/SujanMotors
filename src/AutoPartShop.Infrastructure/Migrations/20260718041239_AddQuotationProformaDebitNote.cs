...
{
    /// <inheritdoc />
    public partial class AddQuotationProformaDebitNote : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerDebitNotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerDebitNotes_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerDebitNotes_Invoices_InvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuotationLines_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QuotationLines_ProductVariants_ProductVariantId",
                    ...
                    table.ForeignKey(
                        name: "FK_QuotationLines_Units_UnitId",
                        column: x => x.UnitId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerDebitNotes_CustomerId",
                table: "CustomerDebitNotes",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerDebitNotes_DebitNoteNumber",
                table: "CustomerDebitNotes",
                column: "DebitNoteNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CustomerDebitNotes_InvoiceId",
                table: "CustomerDebitNotes",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerDebitNotes_Status",
                table: "CustomerDebitNotes",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_ProformaInvoices_ProformaNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuotationLines_PartId",
                table: "QuotationLines",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_QuotationLines_ProductVariantId",
                table: "QuotationLines",
